...
//
// UNTESTED — reach a working board before relying on this. No part of
// the firmware has been driven against real silicon yet. The factory currently
// rejects BTCLOCK_PANEL=7_5 + BTCLOCK_BOARD=V8 at CMake time; the other
