// Auto-generated by idf_cpp_proto/tools/timezone/generate_tz_table.py — do not edit by hand.
// Source of truth: include/timezone_data.hpp (top-level firmware tree).
//
// Zones:  484
// Unique POSIX strings: 93
...
using TzEntry = std::pair<std::string_view, std::string_view>;

inline constexpr std::array<TzEntry, 484> kTzTable = {{
    {"Africa/Abidjan", "GMT0"},
    {"Africa/Accra", "GMT0"},
    ...
    {"Pacific/Yap", "<+10>-10"},
    {"UTC", "UTC0"},
    {"posixrules", "EST5EDT,M3.2.0,M11.1.0"},
}};
