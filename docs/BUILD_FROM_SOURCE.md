...
On each, you'll install Espressif's ESP-IDF v6.0 toolchain, fetch the
...
1. Download the **ESP-IDF v6.0 installer** for Windows from
   https://dl.espressif.com/dl/esp-idf/.
2. Run it; pick the v6.0 branch and the install path
